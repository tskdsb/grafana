...
// Only inserts guid and value - key_path will be set by rvmanager
func (qb *queryBuilder) buildInsertDatastoreBackwardCompatQuery(value []byte, guid string) (string, []interface{}) {
	query := fmt.Sprintf(
	...
	return query, []interface{}{guid, value}
}
